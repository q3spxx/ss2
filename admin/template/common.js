...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalWin = __webpack_require__(175);

	var _modalWin2 = _interopRequireDefault(_modalWin);
	...
	function get() {
		...
		_ajax2.default.send('/admin', body);
	}
	// function del () {
	// 	var body = {
	// 		module: 'main',
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			key: 'openModalWin',
			value: function openModalWin() {
				console.log(this);
				this.setState($.extend(this.state, { modal: true }));
			}
		}, {
			key: 'closeModalWin',
			value: function closeModalWin() {
				_get(App.prototype.__proto__ || Object.getPrototypeOf(App.prototype), 'setState', this).call(this);
				console.log(this);
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'app' },
					this.state.modal ? _react2.default.createElement(_modalWin2.default, {
						successName: 'Принять',
						cancelName: 'Отменить',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _schedule = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moviesList = __webpack_require__(174);
		...
		_createClass(Schedule, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_moviesList2.default, null)
				);
			}
		}]);
	...
	var MoviesList = function (_React$Component) {
		...
		_createClass(MoviesList, [{
			...
			value: function componentDidMount() {
				...
				_ajax2.default.send('/admin', body).then(function (res) {
					console.log(res);
					_this2.setState({
						movies: res
					});
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'moviesList col-lg-3' },
					_react2.default.createElement(
						'div',
						{ className: 'moviesList-buttons' },
						_react2.default.createElement(
							'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalWin = function (_React$Component) {
		_inherits(ModalWin, _React$Component);

		function ModalWin() {
			_classCallCheck(this, ModalWin);

			return _possibleConstructorReturn(this, (ModalWin.__proto__ || Object.getPrototypeOf(ModalWin)).apply(this, arguments));
		}

		_createClass(ModalWin, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'modalWin' },
					this.props.successName ? _react2.default.createElement(
						'button',
						{ className: 'btn btn-success' },
						this.props.successName
					) : "",
					this.props.cancelName ? _react2.default.createElement(
						'button',
						{ className: 'btn btn-default' },
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-default', onClick: this.props.closeModalWin },
						'Закрыть'
					)
				);
			}
